...
class VQA_RAD_dataset:
    ...
    def to_conversation_json(self, save_path: os.PathLike):
        json_data = []
    ...
    def to_jsonl(self, filename: str):
    ...
    def save(self, save_folder: str):
        self.to_jsonl(os.path.join(save_folder, "questions.jsonl"))
        self.to_conversation_json(os.path.join(save_folder, "data.json"))
...
if __name__ == "__main__":
    ...
    train_dataset.save(dataset_train_location)
    test_dataset.save(dataset_test_location)
